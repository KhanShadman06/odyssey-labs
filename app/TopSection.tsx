    ...
    return (
        <>
            <section className="flex mx-10 gap-5 justify-center items-center mt-10">
                <h3 className="font-monument text-2xl font-bold bg-[#9DFF50] p-3 text-[#222] inline-block rounded-xl transform -skew-x-12 md:text-3xl" >Odyssey</h3> <h1 className="inline-block text-2xl text-white font-monument md:text-3xl">
                    Labs
                </h1>
            </section>
