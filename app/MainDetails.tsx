    ...
    return (
        <div>
            <section className="flex mx-10 gap-5 items-center mt-10">
                <h3 className="font-monument text-2xl font-bold bg-[#9DFF50] p-3 inline-block rounded-xl transform -skew-x-12" >Odyssey</h3>
            ...
            <p className="font-Archivo text-center text-white p-3 mt-2">
