        ...
        <div className='pb-10 lg:px-40'>
            ...
            <div className='md:flex justify-between items-center'>
                <section className="flex ml-6 gap-5 items-center">
                    <h1 className="inline-block text-2xl text-[#222] font-monument md:text-3xl xl:text-4xl">
            ...
            <div className='md:hidden'>
                <section className='flex flex-col items-center my-8 gap-3'>
                    <ProjectCard className="w-[343px] h-[311px] lg:w-[500px] lg:h-[570px] min-h-[400px]" />
                </section>
            ...
            <div className='hidden md:block'>
                <section className='flex justify-center items-center my-8 gap-3'>
                    <Image src={arrowLeftFill} alt='arrow-left' />
                    <ProjectCard className="w-[343px] h-[311px] lg:w-[500px] lg:h-[570px] min-h-[400px]" />
                    <ProjectCard className="w-[343px] h-[311px] lg:w-[500px] lg:h-[570px] min-h-[400px]" />
                    <Image src={arrowRightFill} alt='arrow-right' />
            ...
            <div className='flex space-x-4 overflow-x-auto my-5 ml-6 sm:justify-center'>
            ...
            <section className='relative'>
                ...
                <Image src={ArrowGreen} alt='arrow-green' className='absolute right-4 md:right-0 top-6 cursor-pointer' />
            </section>
